...
PNGUID guid = { 0xeb292954, 0xac27, 0x49cf, { 0x88, 0x8d, 0x22, 0xa5, 0xb3, 0x42, 0x05, 0x1c } };
...
const int g_TileRow = 3;
const int g_TileCol = 3;
const int g_CenterX = 1;
const int g_CenterY = 1;
