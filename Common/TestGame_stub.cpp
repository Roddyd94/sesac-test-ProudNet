			...
			case Rmi_SendItemSet:
				{
					...
					int player_nth; __msg >> player_nth;
					std::set<Item> item_set; __msg >> item_set;
					m_core->PostCheckReadMessage(__msg,RmiName_SendItemSet);
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						::Proud::AppendTextOut(parameterString,item_set);	
						
						NotifyCallFromStub(remote, (::Proud::RmiID)Rmi_SendItemSet, 
							RmiName_SendItemSet,parameterString);
			
			#ifdef VIZAGENT
						m_core->Viz_NotifyRecvToStub(remote, (::Proud::RmiID)Rmi_SendItemSet, 
							RmiName_SendItemSet, parameterString);
			#endif
					}
					...
					if(!m_internalUse && m_enableStubProfiling)
					{
						...
						summary.m_rmiID = (::Proud::RmiID)Rmi_SendItemSet;
						summary.m_rmiName = RmiName_SendItemSet;
					...
					if(__ret==false)
					{
						...
						m_core->ShowNotImplementedRmiWarning(RmiName_SendItemSet);
					}
...
__fail:
	...
	const PNTCHAR* Stub::RmiName_SendItemSet =_PNT("SendItemSet");
	#else
	const PNTCHAR* Stub::RmiName_SendItemSet =_PNT("");
	#endif
	#ifdef USE_RMI_NAME_STRING
	...
	#endif
	const PNTCHAR* Stub::RmiName_First = RmiName_SendItemSet;
