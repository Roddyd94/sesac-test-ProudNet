...
public:
  virtual bool SendItems(::Proud::HostID remote,
                         ...
                         const std::vector<Item> &items) PN_SEALED;
  virtual bool SendItems(::Proud::HostID *remotes, int remoteCount,
                         ::Proud::RmiContext &rmiContext, const int &player_nth,
                         const std::vector<Item> &items) PN_SEALED;
  virtual bool SendPlayer(::Proud::HostID remote,
                          ::Proud::RmiContext &rmiContext,
                          const int &player_nth,
                          const Player &player) PN_SEALED;
  virtual bool SendPlayer(::Proud::HostID *remotes, int remoteCount,
                          ::Proud::RmiContext &rmiContext,
                          const int &player_nth,
                          const Player &player) PN_SEALED;
  virtual bool Move(::Proud::HostID remote, ::Proud::RmiContext &rmiContext,
                    const int &key) PN_SEALED;
  virtual bool Move(::Proud::HostID *remotes, int remoteCount,
                    ::Proud::RmiContext &rmiContext, const int &key) PN_SEALED;
  virtual bool WhoAmI(::Proud::HostID remote,
                      ::Proud::RmiContext &rmiContext) PN_SEALED;
  virtual bool WhoAmI(::Proud::HostID *remotes, int remoteCount,
                      ::Proud::RmiContext &rmiContext) PN_SEALED;
  virtual bool WhoYouAre(::Proud::HostID remote,
                         ::Proud::RmiContext &rmiContext,
                         const int &player_nth) PN_SEALED;
  virtual bool WhoYouAre(::Proud::HostID *remotes, int remoteCount,
                         ::Proud::RmiContext &rmiContext,
                         const int &player_nth) PN_SEALED;
